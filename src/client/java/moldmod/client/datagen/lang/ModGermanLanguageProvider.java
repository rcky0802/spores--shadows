...
public class ModGermanLanguageProvider extends AbstractModLanguageProvider {
    ...
    private static final Map<String, String> WOOD_TRANSLATIONS = Map.ofEntries(
        Map.entry("oak", "Eichen"),
        Map.entry("spruce", "Fichten"),
        Map.entry("birch", "Birken"),
        Map.entry("jungle", "Tropenbaum"),
        Map.entry("acacia", "Akazien"),
        Map.entry("dark_oak", "Schwarzeichen"),
        Map.entry("mangrove", "Mangroven"),
        Map.entry("cherry", "Kirschblüten"),
        Map.entry("bamboo", "Bambus"),
        Map.entry("crimson", "Karmesin"),
        Map.entry("warped", "Wirr")
    );
    ...
    protected String getTranslation(String wood, String blockType, String state) {
        ...
        switch (blockType) {
            ...
            case "block": blockSuffix = "block"; gender = "m"; break;
            case "stripped_block": blockSuffix = "block"; gender = "m"; wName = "entrindeter " + wName; break;
            ...
            case "mosaic": blockSuffix = "mosaik"; gender = "n"; break;
            case "mosaic_stairs": blockSuffix = "mosaiktreppe"; gender = "f"; break;
            case "mosaic_slab": blockSuffix = "mosaikstufe"; gender = "f"; break;
    ...
    protected void generateTooltipsAndConfig(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier", "Redstone-Signal-Multiplikator");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier.@Tooltip", "Wird mit der Feuchtigkeitsstufe (0-3) multipliziert, um das Redstone-Signal zu erzeugen.");
        ...
        // Dehumidifier
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".category.dehumidifier", "Luftentfeuchter");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier", "Luftentfeuchter");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.capacity_mb", "Wassertank-Kapazität (mB)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.capacity_mb.@Tooltip", "Maximale Kondenswasserspeicherung in Millibuckets (1000 mB = 1 Eimer).");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.ticks_per_mb", "Ticks pro kondensiertem mB");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.ticks_per_mb.@Tooltip", "Basis-Betriebsticks zur Kondensation von 1 mB Wasser bei hoher Luftfeuchtigkeit.");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.fuel_multiplier", "Brennstoff-Dauermultiplikator");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.fuel_multiplier.@Tooltip", "Multiplikator auf Ofen-Brenndauern (z. B. 4.0 = Kohle brennt 4x länger).");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.drying_power", "Entfeuchtungsleistung (Bonus pro Einheit)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.drying_power.@Tooltip", "Lineare Reduzierung der Ziel-Luftfeuchtigkeit pro aktivem Luftentfeuchter.");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.energy_capacity", "Energiepuffer-Kapazität (E/RF)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.energy_capacity.@Tooltip", "Interner Energiespeicher bei Vorhandensein kompatibler Energiemods (TR/RF).");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.energy_cost_per_tick", "Energieverbrauch (E/Tick)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.dehumidifier.energy_cost_per_tick.@Tooltip", "Pro Tick verbrauchte Energie während des Betriebs anstelle von Festbrennstoff.");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.tainted_planks", "Befallene Bretter können nicht zur Herstellung komplexer Holzgegenstände (Treppen, Stufen, Türen usw.) verwendet werden. Sie können nur an einer Werkbank zu sauberen Brettern aufbereitet (2 befallene Bretter ergeben 1 sauberes Brett) oder in der Welt platziert und mit einer Axt abgeschabt werden.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.moldy_planks", "Schimmlige Bretter können nicht zur Herstellung komplexer Holzgegenstände verwendet werden. Sie können nur an einer Werkbank zu sauberen Brettern aufbereitet (4 schimmlige Bretter ergeben 1 sauberes Brett) oder in der Welt platziert und mit einer Axt geheilt werden.");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.spore_filter", "Wesentliche Filterpatrone. Dient zur Herstellung und Reparatur der Sporenmaske am Amboss sowie als austauschbare Verbrauchspatrone im Luftreiniger.");
        ...
        // Dehumidifier
        translationBuilder.add("block." + moldmod.SporesShadows.MOD_ID + ".dehumidifier", "Luftentfeuchter");
        translationBuilder.add("item." + moldmod.SporesShadows.MOD_ID + ".dehumidifier", "Luftentfeuchter");
        translationBuilder.add("container." + moldmod.SporesShadows.MOD_ID + ".dehumidifier", "Luftentfeuchter");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier", "Aktive Umweltmaschine zur Feuchtigkeitsregulierung. Bietet duale Betriebsmodi: Entfeuchtung (entzieht der Luft Feuchtigkeit mit Stärke 1.0 und kondensiert reines Wasser) oder Befeuchtung/Vernebelung (verbraucht Wasser, um Feuchtigkeit in trockene Räume zu verdampfen). Ausgestattet mit einem internen Wassertank von 2000 mB.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.energy", "Energie & Brennstoff: Unterstützt hybride Doppelstromversorgung. Akzeptiert externe RF / FE / TR Energie (32.000 FE Puffer, 10 FE/Tick Betriebskosten mit höchster Priorität). Verbrennt alternativ feste Brennstoffe (Kohle 4x multipliziert, bis zu 6400 Ticks lang) zur internen Stromerzeugung. Energie kann nicht entnommen werden.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.water", "Wasserproduktion: Im Entfeuchtungsmodus kondensiert die Maschine entzogene Raumfeuchtigkeit und produziert reines flüssiges Wasser im internen Tank (2000 mB mit 1 mB alle 24 Ticks), entnehmbar mit Eimern oder Flüssigkeitsrohren. Im Befeuchtungsmodus verbraucht sie zugeführtes Wasser zur Verdampfung. Flüssigkeitsrohre passen sich automatisch an den aktiven Modus an (Ausgang bei Entfeuchtung, Eingang bei Befeuchtung).");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.automation", "Automatisierung & Steuerung: Alle Seiten akzeptieren festen Brennstoff über Trichter. Enthält GUI-Tasten zum Wechseln des Betriebsmodus (Entfeuchten/Befeuchten) und zur Auswahl der Redstone-Modi (Ignoriert, Aktiv mit Signal, Aktiv ohne Signal). Komparatoren senden ein Redstone-Signal proportional zum Wasserstand (0..15).");

        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.dehumidifier", "Entfeuchtung & Wasser");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.dehumidify", "● Entfeuchtungsmodus");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify", "● Befeuchtungsmodus");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.rate", "+1 mB alle 24 Ticks");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_rate", "-1 mB alle 24 Ticks");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.tank", "Tank: 2000 mB");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.power", "Trocknungskraft: 1.0");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_desc", "Verdampft Feuchtigkeit");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_dehumidify", "Entfeuchtung");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_humidify", "Befeuchtung");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_power", "Krf: 1.0");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.energy_desc", "Energie: 10 FE/t oder Kohle x4 (6400t)");

        // Air Purifier
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.air_purifier", "Reinigung & Filter");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.standard", "● Standard-Dekontamination");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal", "● Tödliches Miasma");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.cleaning", "-48 Miasma (Saubere Luft)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.duration", "Dauer: 2400 Ticks (2 Min.)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal_duration", "Dauer: 1200 Ticks (1 Min.)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_standard", "1x normaler Verbrauch");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_lethal", "2x doppelter Verbrauch");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_standard", "Luftreinigung");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_lethal", "Tödl. Miasma");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_rate_standard", "Verbr: 1x");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_rate_lethal", "Verbr: 2x");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.energy_desc", "Energie: 10 FE/t oder Kohle x4 (6400t)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier", "Aktive Umweltmaschine zur Dekontamination von giftigem Miasma. Reinigt die Luft in geschlossenen oder unterirdischen Räumen, entfernt standardmäßig 48 Punkte Miasma und stellt saubere Luftqualität (CLEAN) wieder her. Benötigt Filterpatronen zum Betrieb.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.energy", "Energie & Brennstoff: Unterstützt hybride Doppelstromversorgung. Akzeptiert externe RF / FE / TR Energie (32.000 FE Puffer, 10 FE/Tick Betriebskosten mit höchster Priorität). Verbrennt alternativ feste Brennstoffe (Kohle 4x multipliziert, bis zu 6400 Ticks lang) zur internen Stromerzeugung. Energie kann nicht entnommen werden.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.filters", "Filterverbrauch: Zur Dekontamination der Luft und Entfernung von 48 Miasmapunkten verbraucht die Maschine Sporenfilter-Patronen im dedizierten Slot. Jeder Filter bietet 2400 Ticks (2 Minuten) aktive Reinigung und verbraucht sich bei tödlichem Miasma doppelt so schnell. Bei Erschöpfung wird automatisch eine neue Patrone aus dem Stapel entnommen.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.automation", "Automatisierung & Steuerung: Die Oberseite (UP) akzeptiert Sporenfilter aus Trichtern, während Seiten- und Unterseiten festen Brennstoff akzeptieren. Enthält eine GUI-Taste zur Auswahl der Redstone-Modi (Ignoriert, Aktiv mit Signal, Aktiv ohne Signal). Komparatoren senden ein Redstone-Signal proportional zu Filtervorrat und -integrität (0..15).");

        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.water", "Wasser: %d / %d mB");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.energy", "Energie: %d / %d E");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.energy_usage", "Verbrauch: %d E/t (%d E/s)");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone_mode", "Redstone-Modus: %s");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.ignored", "Ignoriert");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.ignored.desc", "Immer aktiv, solange versorgt");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.low", "Niedrig");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.low.desc", "Aktiv ohne Signal; pausiert bei Redstone");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.high", "Hoch");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.redstone.high.desc", "Nur aktiv bei Redstone-Signal");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status.running", "● Aktiv");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status.full", "● Voll");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status.off", "● Inaktiv");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status_desc.running", "Maschine entfeuchtet aktiv den Raum.");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status_desc.full", "Interner Wassertank ist voll (2000 mB). Wasser ablassen zum Fortfahren.");
        translationBuilder.add("gui." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.status_desc.off", "Maschine ist inaktiv (benötigt Energie/Brennstoff, gültigen Raum oder Redstone-Signal).");
        ...
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.air_purifier.status.filter_depleted", "Filter verbraucht");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.status", "Status: ");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.status.running", "In Betrieb");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.status.full", "Standby (Voll)");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.status.off", "Aus");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.water", "Wasser: %d / %d mB");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.energy", "Energie: %d E");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.fuel_min_sec", "Brennstoff: %dm %ds");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.dehumidifier.fuel_sec", "Brennstoff: %ds");

        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.title", "Feuchtigkeitserkennung");
        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.description", "Stelle einen Feuchtigkeitsdetektor her, um die Raumfeuchte zu überwachen.");
        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".dehumidifier_craft.title", "Klimaregulierung");
        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".dehumidifier_craft.description", "Stelle einen Luftentfeuchter her, um geschlossene Räume zu trocknen und Kondenswasser zu sammeln.");
        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".dry_oasis.title", "Unterirdische Oase");
        translationBuilder.add("advancements." + moldmod.SporesShadows.MOD_ID + ".dry_oasis.description", "Trockne eine unterirdische Kammer (Y <= 40) mit einem Entfeuchter auf unter 15% Luftfeuchtigkeit.");
        ...
        translationBuilder.add("advancements.spores--shadows.air_purifier_craft.description", "Stelle einen Luftreiniger her, um Miasma zu beseitigen und geschlossene Räume atembar zu machen.");
        translationBuilder.add("advancements.spores--shadows.air_purifier_craft.title", "Hermetischer Bunker");
        translationBuilder.add("advancements.spores--shadows.pure_air_depths.description", "Dekontaminiere einen schimmelbefallenen unterirdischen Raum (Y <= 0) vollständig und stelle saubere Luft (CLEAN) her.");
        translationBuilder.add("advancements.spores--shadows.pure_air_depths.title", "Reine Luft in der Tiefe");
        translationBuilder.add("advancements.spores--shadows.spore_detector.description", "Stelle einen Sporendetektor her, um die Luftqualität und giftiges Miasma zu überwachen.");
        translationBuilder.add("advancements.spores--shadows.spore_detector.title", "Luftwächter");
        translationBuilder.add("block.spores--shadows.air_purifier", "Luftreiniger");
        translationBuilder.add("container.spores--shadows.air_purifier", "Luftreiniger");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.filter_depleted", "Filter Erschöpft");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.off", "Aus");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.running", "Aktiv");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.filter_depleted", "Der Sporenfilter ist vollständig abgenutzt. Setze einen neuen Filter ein.");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.off", "Maschine ist inaktiv (benötigt Energie/Brennstoff, gültigen Raum oder Redstone-Signal).");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.running", "Der Luftreiniger filtert aktiv Sporen aus dem Raum.");
        translationBuilder.add("gui.spores--shadows.dehumidifier.status.humidifying", "Verdampfung");
        translationBuilder.add("gui.spores--shadows.dehumidifier.status.water_empty", "Wassertank leer");
        translationBuilder.add("item.spores--shadows.air_purifier", "Luftreiniger");
        translationBuilder.add("message.spores--shadows.detector.dehumidifiers_active", "§7- Luftentfeuchter: §b%d §7(Trocknung: §b-%s§7)");
        translationBuilder.add("message.spores--shadows.detector.dehumidifiers_none", "§7- Luftentfeuchter: §8Keine");
        translationBuilder.add("message.spores--shadows.detector.humidifiers_active", "§7- Luftbefeuchter: §b%d §7(Befeuchtung: §b+%s§7)");
        translationBuilder.add("message.spores--shadows.detector.purifiers_active", "§7- Luftreiniger: §b%d §7(Filterung: §b-%s Miasma§7)");
        translationBuilder.add("message.spores--shadows.detector.purifiers_none", "§7- Luftreiniger: §8Keine");
        translationBuilder.add("text.autoconfig.spores--shadows.category.air_purifier", "Luftreiniger");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier", "Luftreiniger");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_capacity", "Energiepuffer-Kapazität (E/RF)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_capacity.@Tooltip", "Interne Energiespeicherung bei vorhandenen externen Energie-Mods (TR/RF).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_cost_per_tick", "Energieverbrauch (E/Tick)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_cost_per_tick.@Tooltip", "Energieverbrauch pro Tick während des Betriebs anstelle von festem Brennstoff.");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.filter_durability_ticks", "Filterhaltbarkeit (Ticks)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.filter_durability_ticks.@Tooltip", "Betriebsticks, bevor ein aktiver Sporenfilter verbraucht ist (2400 Ticks = 2 Minuten Basis).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.fuel_multiplier", "Brennstoff-Dauermultiplikator");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.fuel_multiplier.@Tooltip", "Multiplikator für normale Ofen-Brenndauern (z. B. 4.0 = Kohle hält 4x länger).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.purifier_cleaning_power", "Reinigungskraft (Bonus pro Einheit)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.purifier_cleaning_power.@Tooltip", "Linearer Abzug vom Raum-Miasma-Wert pro aktivem Luftreiniger.");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.energy", "Energie: %d / %d E");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.energy_usage", "Verbrauch: %d E/t (%d E/s)");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.filter_backup", "Reserve: %d Filter verfügbar");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.filter_integrity", "Aktiver Filterzustand: %d%%");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.high", "Hoch");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.high.desc", "Nur bei Redstone-Signal aktiv");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.ignored", "Ignoriert");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.ignored.desc", "Immer aktiv, solange mit Energie versorgt");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.low", "Niedrig");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.low.desc", "Aktiv ohne Signal; pausiert durch Redstone");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone_mode", "Redstone-Modus: %s");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode", "Modus: %s");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.dehumidify", "Entfeuchten");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.dehumidify.desc", "Entzieht dem Raum Feuchtigkeit und sammelt Kondenswasser");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.fluid_info.dehumidify", "Rohre/Eimer: Nur Entnahme (Kondenswasser)");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.fluid_info.humidify", "Rohre/Eimer: Nur Einspeisung (Reines Wasser)");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.humidify", "Befeuchten");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.humidify.desc", "Verbraucht Wasser zur Raumbefeuchtung");
        translationBuilder.add("tooltip.spores--shadows.jade.dehumidifier.status.humidifying", "Verdampfend");
        translationBuilder.add("tooltip.spores--shadows.jade.dehumidifier.status.water_empty", "Tank leer");
        // JEI Mold Infection Category Translations
        translationBuilder.add("jei.spores--shadows.category.mold_infection", "Schimmelinfektion");
        translationBuilder.add("jei.spores--shadows.infection.note", "Random Tick • Ungewachst");
        translationBuilder.add("jei.spores--shadows.infection.stage_0_to_1", "Sauber → Befallen");
        translationBuilder.add("jei.spores--shadows.infection.stage_1_to_2", "Befallen → Schimmelig");
        translationBuilder.add("jei.spores--shadows.infection.stage_2_to_3", "Schimmelig → Verrottet");
        translationBuilder.add("jei.spores--shadows.infection.threshold", "Risiko > %d%%");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.condition", "Bedingung: Umweltrisiko (R) > %d%%");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.cure", "Heilung: Mit einer Axt abschaben, um Schimmelstufen rückgängig zu machen.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.desc1", "Ungewachste Blöcke steigen bei zufälligen Ticks in die nächste Stufe auf, wenn das Risiko den Schwellenwert überschreitet.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.desc2", "Das Risiko steigt in dunklen, feuchten, unbelüfteten oder sporenbelasteten Bereichen.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.prevention", "Immunität: Mit Honigwabe wachsen, um Schimmel dauerhaft zu verhindern.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.title", "● Schimmel-Fortschreitung");
