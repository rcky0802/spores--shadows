...
public class ModItalianLanguageProvider extends AbstractModLanguageProvider {
    ...
    protected void generateTooltipsAndConfig(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier", "Moltiplicatore Livello Pietrarossa");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier.@Tooltip", "Moltiplicato per lo stadio di umidità (0-3) per produrre il segnale.");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier", "Macchinario ambientale attivo per la regolazione dell'umidità. Opera in doppia modalità: Deumidificazione (estrae l'umidità dall'aria con potenza 1.0 e condensa acqua pura) o Umidificazione/Nebulizzazione (consuma acqua per vaporizzare umidità nelle stanze secche). Dotato di un serbatoio interno da 2000 mB.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.energy", "Energia e Carburante: Supporta alimentazione ibrida duale. Accetta energia esterna RF / FE / TR (buffer di 32.000 FE, consumo operativo di 10 FE/tick con massima priorità). In alternativa, brucia combustibili solidi (Carbone moltiplicato x4, fino a 6400 tick) per generare elettricità interna. L'energia non può essere estratta.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.water", "Produzione Acqua: In modalità Deumidificazione, il macchinario condensa l'umidità estratta dalla stanza e produce acqua liquida pura nel serbatoio interno (2000 mB a 1 mB ogni 24 tick), estraibile con secchi o condotti fluidi. In modalità Umidificazione consuma invece acqua pura inserita nel serbatoio per vaporizzarla. I condotti fluidi si adattano automaticamente alla modalità attiva (output in deumidificazione, input in umidificazione).");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.automation", "Automazione e Controlli: Tutte le facce accettano combustibile solido da tramogge/hopper. Include pulsanti nella GUI per cambiare modalità operativa (Deumidifica/Umidifica) e modalità redstone (Ignora, Attivo con segnale, Attivo senza segnale). I comparatori emettono un segnale proporzionale al livello dell'acqua (0..15).");

        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.dehumidifier", "Deumidificazione & Acqua");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.dehumidify", "● Modalità Deumidificazione");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify", "● Modalità Umidificazione");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.rate", "+1 mB ogni 24 tick");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_rate", "-1 mB ogni 24 tick");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.tank", "Serbatoio: 2000 mB");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.power", "Potenza Essiccazione: 1.0");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_desc", "Vaporizzazione Umidità");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_dehumidify", "Deumidificazione");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_humidify", "Umidificazione");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.energy_desc", "Alimentazione: 10 FE/t o Carbone x4 (6400t)");

        // Air Purifier
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.air_purifier", "Purificazione & Filtri");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.standard", "● Bonifica Standard");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal", "● Miasma Letale");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.cleaning", "-48 Miasma (Aria Pulita)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.duration", "Durata: 2400 tick (2 min)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal_duration", "Durata: 1200 tick (1 min)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_standard", "Consumo 1x normale");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_lethal", "Consumo 2x raddoppiato");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_standard", "Purificazione");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_lethal", "Miasma Letale");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.energy_desc", "Alimentazione: 10 FE/t o Carbone x4 (6400t)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier", "Macchinario ambientale attivo per la bonifica del miasma tossico. Depura l'aria delle stanze chiuse o sotterranee rimuovendo di default 48 punti di miasma tossico e ripristinando la qualità dell'aria pulita (CLEAN). Richiede cartucce filtranti per operare.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.energy", "Energia e Carburante: Supporta alimentazione ibrida duale. Accetta energia esterna RF / FE / TR (buffer di 32.000 FE, consumo operativo di 10 FE/tick con massima priorità). In alternativa, brucia combustibili solidi (Carbone moltiplicato x4, fino a 6400 tick) per generare elettricità interna. L'energia non può essere estratta.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.filters", "Consumo Filtri: Per decontaminare l'aria e rimuovere 48 punti di miasma, il macchinario consuma cartucce Filtro Antispore caricate nello slot dedicato. Ogni filtro garantisce 2400 tick (2 minuti) di purificazione continua, consumandosi al doppio della velocità in presenza di miasma letale. Quando una cartuccia si esaurisce, la successiva viene prelevata automaticamente dallo stack.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.automation", "Automazione e Controlli: La faccia superiore (UP) accetta Filtri Antispore da tramogge/hopper, mentre le facce laterali e inferiore accettano combustibile solido. Include un pulsante nella GUI per la modalità redstone (Ignora, Attivo con segnale, Attivo senza segnale). I comparatori emettono un segnale proporzionale alla scorta e integrità dei filtri (0..15).");
        ...
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.air_purifier.status.filter_depleted", "Filtro Esaurito");
