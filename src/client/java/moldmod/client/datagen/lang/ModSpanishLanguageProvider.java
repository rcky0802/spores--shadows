...
public class ModSpanishLanguageProvider extends AbstractModLanguageProvider {
    ...
    protected String getTranslation(String wood, String blockType, String state) {
        ...
        switch (blockType) {
            ...
            case "block": blockName = "Bloque"; break;
            case "stripped_block": blockName = "Bloque sin corteza"; break;
            ...
            case "mosaic_stairs": blockName = "Escaleras de mosaico"; isFeminine = true; isPlural = true; break;
            case "mosaic_slab": blockName = "Losa de mosaico"; isFeminine = true; break;
    ...
    protected void generateTooltipsAndConfig(TranslationBuilder translationBuilder) {
        ...
        // Moisture Detector
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".category.moisture_detector", "Detector de Humedad");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector", "Detector de Humedad");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.block_initial_delay_ticks", "Retardo Inicial del Bloque (ticks)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.block_initial_delay_ticks.@Tooltip", "Ticks antes del primer escaneo tras colocar el bloque.");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.block_periodic_delay_ticks", "Retardo Periódico del Bloque (ticks)");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.block_periodic_delay_ticks.@Tooltip", "Ticks entre escaneos periódicos.");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier", "Multiplicador de Nivel de Redstone");
        translationBuilder.add("text.autoconfig." + moldmod.SporesShadows.MOD_ID + ".option.moistureDetector.redstone_level_multiplier.@Tooltip", "Multiplicado por el nivel de humedad (0-3) para producir la señal de redstone.");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.tainted_planks", "Los tablones contaminados no se pueden usar para fabricar objetos de madera complejos (escaleras, losas, puertas, etc.). Solo se pueden recuperar como tablones sanos en una mesa de trabajo (2 tablones contaminados producen 1 tablón sano) o rasparse con un hacha una vez colocados en el mundo.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.moldy_planks", "Los tablones mohosos no se pueden usar para fabricar objetos de madera complejos. Solo se pueden recuperar como tablones sanos en una mesa de trabajo (4 tablones mohosos producen 1 tablón sano) o limpiarse con un hacha una vez colocados en el mundo.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.spore_mask", "La Máscara Antiesporas proporciona protección total contra el miasma tóxico (Veneno, Náusea y Hambre). Consume durabilidad al filtrar el aire tóxico. Cambia el filtro reparándola con un Filtro de Esporas en un yunque (la repara por completo de un solo uso). En una mesa de trabajo, solo puedes combinar dos máscaras para una reparación rápida de emergencia. Solo se puede encantar con Irrompibilidad, Reparación y Maldición de Desaparición.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.spore_filter", "Cartucho de filtración esencial. Se utiliza para fabricar y reparar la Máscara de Esporas en un yunque, y como cartucho consumible reemplazable en el Purificador de Aire.");
        ...
        translationBuilder.add("config.jade.plugin_" + moldmod.SporesShadows.MOD_ID + ".spore_detector_info", "Spores & Shadows: Info del Detector de Esporas");

        translationBuilder.add("item." + moldmod.SporesShadows.MOD_ID + ".spore_mask", "Máscara Antiesporas");
        translationBuilder.add("item." + moldmod.SporesShadows.MOD_ID + ".spore_filter", "Filtro de Esporas");
        translationBuilder.add("block." + moldmod.SporesShadows.MOD_ID + ".spore_detector", "Detector de Esporas");
        translationBuilder.add("item." + moldmod.SporesShadows.MOD_ID + ".spore_detector", "Detector de Esporas");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.spore_detector", "El Detector de Miasma mide la toxicidad del aire y la ventilación de la habitación. Clic Derecho en el aire para escanear. Se puede colocar en paredes o suelos.");

        translationBuilder.add("config.jade.plugin_" + moldmod.SporesShadows.MOD_ID + ".moisture_detector_info", "Spores & Shadows: Info del Detector de Humedad");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier", "Maquinaria ambiental activa para la regulación de la humedad. Cuenta con dos modos de funcionamiento: Deshumidificación (extrae la humedad del aire con potencia 1.0 y condensa agua pura) o Humidificación/Nebulización (consume agua para vaporizar humedad en habitaciones secas). Equipada con un depósito interno de 2000 mB.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.energy", "Energía y Combustible: Admite alimentación híbrida dual. Acepta energía externa RF / FE / TR (búfer de 32.000 FE, costo operativo de 10 FE/tick con máxima prioridad). Como alternativa, quema combustibles sólidos (Carbón multiplicado x4, hasta 6400 ticks) para generar electricidad interna. La energía no se puede extraer.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.water", "Producción de Agua: En modo Deshumidificación, la máquina condensa la humedad extraída de la habitación y produce agua líquida pura en el depósito interno (2000 mB a 1 mB cada 24 ticks), extraíble mediante cubos o tuberías de fluidos. En modo Humidificación consume agua pura suministrada para vaporizarla. Las tuberías de fluidos se adaptan automáticamente al modo activo (salida en deshumidificación, entrada en humidificación).");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.dehumidifier.automation", "Automatización y Controles: Todos los lados aceptan combustible sólido mediante tolvas. Cuenta con botones en la GUI para alternar el modo de funcionamiento (Deshumidificar/Humidificar) y los modos de control de redstone (Ignorado, Activo con señal, Activo sin señal). Los comparadores emiten una señal de redstone proporcional al nivel de agua (0..15).");

        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.dehumidifier", "Deshumidificación y Agua");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.dehumidify", "● Modo Deshumidificar");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify", "● Modo Humidificar");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.rate", "+1 mB cada 24 ticks");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_rate", "-1 mB cada 24 ticks");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.tank", "Tanque: 2000 mB");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.power", "Poder de Secado: 1.0");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.humidify_desc", "Vaporiza Humedad");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_dehumidify", "Deshumidificar");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_humidify", "Humidificar");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_tank", "Máx: 2000 mB");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.short_power", "Pot: 1.0");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".dehumidifier.energy_desc", "Energía: 10 FE/t o Carbón x4 (6400t)");

        // Air Purifier
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".category.air_purifier", "Purificación y Filtros");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.standard", "● Descontaminación Estándar");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal", "● Miasma Letal");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.cleaning", "-48 Miasma (Aire Limpio)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.duration", "Duración: 2400 ticks (2 min)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.lethal_duration", "Duración: 1200 ticks (1 min)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_standard", "Consumo normal 1x");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.rate_lethal", "Consumo duplicado 2x");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_standard", "Purificación");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.short_lethal", "Miasma Letal");
        ...
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".air_purifier.energy_desc", "Energía: 10 FE/t o Carbón x4 (6400t)");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier", "Maquinaria ambiental activa para la descontaminación del miasma tóxico. Purifica el aire en habitaciones cerradas o subterráneas eliminando por defecto 48 puntos de miasma tóxico y restableciendo la calidad del aire limpio (CLEAN). Requiere cartuchos filtrantes para funcionar.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.energy", "Energía y Combustible: Admite alimentación híbrida dual. Acepta energía externa RF / FE / TR (búfer de 32.000 FE, costo operativo de 10 FE/tick con máxima prioridad). Como alternativa, quema combustibles sólidos (Carbón multiplicado x4, hasta 6400 ticks) para generar electricidad interna. La energía no se puede extraer.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.filters", "Consumo de Filtros: Para descontaminar el aire y eliminar 48 puntos de miasma, la máquina consume cartuchos de Filtro de Esporas en la ranura dedicada. Cada filtro proporciona 2400 ticks (2 minutos) de purificación continua, consumiéndose el doble de rápido bajo miasma letal. Al agotarse, se extrae automáticamente un nuevo filtro de la pila.");
        translationBuilder.add("jei." + moldmod.SporesShadows.MOD_ID + ".info.air_purifier.automation", "Automatización y Controles: La cara superior (UP) acepta Filtros de Esporas desde tolvas, mientras que las caras laterales e inferior aceptan combustible sólido. Incluye un botón en la GUI para alternar los modos de redstone (Ignorado, Activo con señal, Activo sin señal). Los comparadores emiten una señal de redstone proporcional a la reserva e integridad de los filtros (0..15).");
        ...
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.air_purifier.status.filter_depleted", "Filtro Agotado");
        ...
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.spore_detector.clean", "Aire Limpio");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.spore_detector.warning", "Advertencia (Bajo)");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.spore_detector.moderate", "Moderado (Hambre)");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.spore_detector.lethal", "Letal (Veneno)");

        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.moisture_detector.effective_moisture", "Nivel de Humedad: ");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.moisture_detector.dry", "Seco");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.moisture_detector.moderate", "Moderado");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.moisture_detector.humid", "Húmedo");
        translationBuilder.add("tooltip." + moldmod.SporesShadows.MOD_ID + ".jade.moisture_detector.critical", "Crítico");

        // Shared Detector Messages
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".detector.blocks_dist", "%d bloques");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".detector.none", "Ninguna");

        // Spore Detector Chat Messages
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.header", "§6[Detector de Esporas] ");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.clean", "§aAIRE LIMPIO §7(Seguro)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.warning", "§eADVERTENCIA §7(Bajas esporas flotando en el aire)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.moderate", "§6RIESGO MODERADO §7(Hambre inminente)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.lethal", "§4PELIGRO LETAL §7(¡Veneno y náuseas inminentes!)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.metric", "§7- Densidad de esporas: §d%s/b");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.open_air", "§7- Entorno: §aAire Libre §7| Dist. a ventilación: §b0 bloques");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.room", "§7- Volumen de habitación: §f%d bloques §7| Dist. a ventilación: §b%s");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.aeration", "§7- Aireación local: §a%s flujo §7(§b%s§7) | Miasma de habitación: §6%s");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.trend_stable", "§7- Tendencia: §a= ESTABLE");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.trend_purifying", "§7- Tendencia: §b▼ PURIFICANDO / DISIPANDO §7(Objetivo: §f%s§7)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".spore_detector.trend_accumulating", "§7- Tendencia: §c▲ ACUMULANDO / SATURANDO §7(Objetivo: §f%s§7)");

        // Moisture Detector Chat Messages
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.header", "§6[Detector de Humedad] ");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.dry", "§aSECO §7(Seguro para estructuras de madera)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.moderate", "§eMODERADO §7(Precaución: umbral de moho cercano)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.humid", "§6HÚMEDO §7(Advertencia: ¡alto riesgo de moho!)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.critical", "§4CRÍTICO §7(Peligro: ¡descomposición rápida y saturación!)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.metric", "§7- Humedad Efectiva: §b%s");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.open_air", "§7- Entorno: §aAire Libre §7| Dist. a ventilación: §b0 bloques");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.room", "§7- Volumen de habitación: §f%d bloques §7| Dist. a ventilación: §b%s");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.aeration", "§7- Aireación local: §a%s flujo §7(§b%s§7) | Humedad Cruda: §f%s");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.trend_stable", "§7- Tendencia: §a= ESTABLE");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.trend_drying", "§7- Tendencia: §b▼ SECADO / VENTILACIÓN §7(Objetivo: §f%s§7)");
        translationBuilder.add("message." + moldmod.SporesShadows.MOD_ID + ".moisture_detector.trend_humidifying", "§7- Tendencia: §c▲ HUMEDECIENDO / SATURANDO §7(Objetivo: §f%s§7)");
        ...
        translationBuilder.add("advancements.spores--shadows.air_purifier_craft.description", "Fabrica un Purificador de Aire para purgar el miasma y hacer respirables las habitaciones cerradas.");
        translationBuilder.add("advancements.spores--shadows.air_purifier_craft.title", "Búnker Hermético");
        translationBuilder.add("advancements.spores--shadows.pure_air_depths.description", "Descontamina por completo una habitación subterránea infestada de moho (Y <= 0), restableciendo el aire a nivel LIMPIO.");
        translationBuilder.add("advancements.spores--shadows.pure_air_depths.title", "Aire Puro en las Profundidades");
        translationBuilder.add("advancements.spores--shadows.spore_detector.description", "Fabrica un Detector de Esporas para monitorear la calidad del aire y el miasma tóxico.");
        translationBuilder.add("advancements.spores--shadows.spore_detector.title", "Centinela del Aire");
        translationBuilder.add("block.spores--shadows.air_purifier", "Purificador de Aire");
        translationBuilder.add("container.spores--shadows.air_purifier", "Purificador de Aire");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.filter_depleted", "Filtro Agotado");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.off", "Apagado");
        translationBuilder.add("gui.spores--shadows.air_purifier.status.running", "Activo");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.filter_depleted", "El filtro de esporas activo está completamente desgastado. Inserte un nuevo filtro.");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.off", "Máquina inactiva (requiere energía/combustible, habitación válida o señal de redstone).");
        translationBuilder.add("gui.spores--shadows.air_purifier.status_desc.running", "El purificador de aire está purificando activamente la habitación de esporas.");
        translationBuilder.add("gui.spores--shadows.dehumidifier.status.humidifying", "Vaporización");
        translationBuilder.add("gui.spores--shadows.dehumidifier.status.water_empty", "Depósito vacío");
        translationBuilder.add("item.spores--shadows.air_purifier", "Purificador de Aire");
        translationBuilder.add("message.spores--shadows.detector.dehumidifiers_active", "§7- Deshumidificadores: §b%d §7(Secado: §b-%s§7)");
        translationBuilder.add("message.spores--shadows.detector.dehumidifiers_none", "§7- Deshumidificadores: §8Ninguno");
        translationBuilder.add("message.spores--shadows.detector.humidifiers_active", "§7- Humidificadores: §b%d §7(Humidificación: §b+%s§7)");
        translationBuilder.add("message.spores--shadows.detector.purifiers_active", "§7- Purificadores de Aire: §b%d §7(Filtración: §b-%s miasma§7)");
        translationBuilder.add("message.spores--shadows.detector.purifiers_none", "§7- Purificadores de Aire: §8Ninguno");
        translationBuilder.add("text.autoconfig.spores--shadows.category.air_purifier", "Purificador de Aire");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier", "Purificador de Aire");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_capacity", "Capacidad de Búfer Energético (E/RF)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_capacity.@Tooltip", "Almacenamiento interno de energía cuando hay mods energéticos compatibles (TR/RF).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_cost_per_tick", "Consumo Energético (E/tick)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.energy_cost_per_tick.@Tooltip", "Energía consumida por tick durante el funcionamiento en lugar de combustible sólido.");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.filter_durability_ticks", "Durabilidad del Filtro (Ticks)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.filter_durability_ticks.@Tooltip", "Ticks operativos antes de que un filtro de esporas activo se agote (2400 ticks = 2 minutos base).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.fuel_multiplier", "Multiplicador de Duración de Combustible");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.fuel_multiplier.@Tooltip", "Multiplicador aplicado al tiempo de combustión estándar de hornos (ej. 4.0 = el carbón dura 4x más).");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.purifier_cleaning_power", "Poder Purificador (Bonificación por Unidad)");
        translationBuilder.add("text.autoconfig.spores--shadows.option.airPurifier.purifier_cleaning_power.@Tooltip", "Reducción lineal restada a la puntuación de miasma de la habitación por cada purificador activo.");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.energy", "Energía: %d / %d E");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.energy_usage", "Consumo: %d E/t (%d E/s)");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.filter_backup", "Reserva: %d filtros disponibles");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.filter_integrity", "Integridad del Filtro Activo: %d%%");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.high", "Alto");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.high.desc", "Activo solo con señal de redstone");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.ignored", "Ignorado");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.ignored.desc", "Siempre activo mientras tenga energía");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.low", "Bajo");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone.low.desc", "Activo sin señal; pausado por redstone");
        translationBuilder.add("tooltip.spores--shadows.air_purifier.redstone_mode", "Modo Redstone: %s");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode", "Modo: %s");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.dehumidify", "Deshumidificar");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.dehumidify.desc", "Extrae la humedad ambiental y condensa agua pura");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.fluid_info.dehumidify", "Tuberías/Cubos: Solo extracción (agua condensada)");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.fluid_info.humidify", "Tuberías/Cubos: Solo inserción (agua pura)");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.humidify", "Humidificar");
        translationBuilder.add("tooltip.spores--shadows.dehumidifier.mode.humidify.desc", "Consume agua del depósito para vaporizar humedad en la habitación");
        translationBuilder.add("tooltip.spores--shadows.jade.dehumidifier.status.humidifying", "Vaporización");
        translationBuilder.add("tooltip.spores--shadows.jade.dehumidifier.status.water_empty", "Depósito vacío");
        // JEI Mold Infection Category Translations
        translationBuilder.add("jei.spores--shadows.category.mold_infection", "Infección de Moho");
        translationBuilder.add("jei.spores--shadows.infection.note", "Random Tick • Sin Encerar");
        translationBuilder.add("jei.spores--shadows.infection.stage_0_to_1", "Limpio → Contaminado");
        translationBuilder.add("jei.spores--shadows.infection.stage_1_to_2", "Contaminado → Enmohecido");
        translationBuilder.add("jei.spores--shadows.infection.stage_2_to_3", "Enmohecido → Podrido");
        translationBuilder.add("jei.spores--shadows.infection.threshold", "Riesgo > %d%%");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.condition", "Condición: Riesgo Ambiental (R) > %d%%");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.cure", "Cura: Raspa con un Hacha una vez colocado para revertir las etapas de moho.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.desc1", "Los bloques sin encerar avanzan a la siguiente etapa de moho durante los random ticks cuando el riesgo supera el umbral.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.desc2", "El rischio aumenta en áreas oscuras, húmedas, estancadas o con esporas.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.prevention", "Inmunidad: Encera con Panal para prevenir el moho permanentemente.");
        translationBuilder.add("jei.spores--shadows.infection.tooltip.title", "● Progresión de Infección de Moho");
        // Tag Translations (Fabric Tag Convention v2)
        translationBuilder.add("tag.item." + moldmod.SporesShadows.MOD_ID + ".moldy_items", "Objetos Mohosos");
