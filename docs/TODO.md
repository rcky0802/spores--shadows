...
- [ ] **Integrare l'aerazione/ventilazione nella formula di calcolo del rischio muffa ($R$)**
...
- [ ] **Nuovo Elmo: Maschera Antispore / Respiratore (*Spore Mask / Respirator*)**
  ...
  * **Bilanciamento & Durabilità**: Consuma durabilità progressiva nel tempo mentre filtra attivamente il miasma presente nell'ambiente.
  * **Stato**: ⏳ *Pianificato*
