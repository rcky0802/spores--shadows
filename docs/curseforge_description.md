...
**Spores & Shadows** transforms wood into a living, vulnerable material that decays dynamically based on its environment. Featuring nearly **1,000 survival-ready block variants**, no wooden build is safe from time and the elements.
...
* **Toxic Miasma:** Dense clusters of moldy and rotten blocks release visible spore clouds inflicting **Nausea** and **Poison** on unprotected players.
